  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen p-4 sm:p-6 md:p-8">
      <div className="w-full max-w-2xl">
        ...
        <Card className="w-full shadow-2xl rounded-xl border bg-card/80 backdrop-blur-sm">
                    ...
                    <FormItem>
                      <FormControl>
                        <Textarea
                          ...
                          className="resize-none min-h-[120px] text-base rounded-lg bg-background"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
            ...
            <CardFooter className="flex flex-col items-start gap-6 p-6">
              <div className={`w-full space-y-8 animate-in fade-in-50 duration-500 border-t ${getSentimentBorderColor(analysisResult.sentiment)} pt-6`}>
                <div className="space-y-3">
                  <h3 className="font-headline text-xl flex items-center gap-2 font-semibold">
                  ...
                  <p className="text-md text-muted-foreground">{analysisResult.explanation}</p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {analysisResult.psychologicalTones.split(',').map(tone => tone.trim()).map((tone, index) => (
                      <Badge key={index} variant="secondary" className="text-sm py-1 px-3 rounded-full">{tone}</Badge>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <blockquote className="p-4 bg-primary/10 rounded-lg border-l-4 border-primary">
                    <p className="italic text-primary-foreground/90 text-lg">
